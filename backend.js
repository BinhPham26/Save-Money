...
function handleRequest(e) {
  ...
  try {
    // 1. Parse Parameters (Handle both Query Params and JSON Body)
    ...
    if (!params || !params.action) {
      return ContentService.createTextOutput(JSON.stringify({ success: false, message: "No parameters or action found" }))
    ...
    const data = params.data; // JSON string for users data
